...
export const getGradedASNTS = (username, token) => {
  return dispatch => {
    ...
    axios
      .get(`https://koitoror-university.herokuapp.com/graded-assignments/?username=${username}`)
      .then(res => {
...
export const createGradedASNT = (token, asnt) => {
  return dispatch => {
    ...
    axios
      .post(`https://koitoror-university.herokuapp.com/graded-assignments/create/`, asnt)
      .then(res => {
        console.log("success");
